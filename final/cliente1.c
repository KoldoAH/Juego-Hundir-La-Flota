 ...
 * DESCRIPCION: cliente del objetivo 1 de la Practica final.
...
int main(int argc,char* argv[]) {
	...
	if(strcmp(buffer_fd, "S HOLA\n") == 0){
		printf("Bienvenido a la partida de hundir la flota\n");
		...
		printf("Lo sentimos, el servidor está lleno\n");
		close(socketfd);
		return EXIT_SUCCESS;
	}
}